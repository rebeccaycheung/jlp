    ...
    <section>
      <b-tabs class="block">
        ...
        <b-tab-item :label="$options.title5">
          <Paragraph :list="$options.content6"/>
          <UnorderedList :list="$options.list3"/>
          <Paragraph :list="$options.content7"/>
        </b-tab-item>
      </b-tabs>
    </section>
  </div>
...
export default {
  ...
  title2: `Who can help?`,
  content2: [`A number of specialist support services exist which can provide services such as:`],
  list1: [
  ...
  content3: [`To protect those suffering from family violence, there are a number of specialist government services available including:`],
  list2: [
  ...
  title3: `Counselling and support`,
  content4: [
